    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background">
        <div className="text-center">
          ...
          <Link to="/" className="text-[11px] font-bold uppercase tracking-[0.3em] text-foreground underline">
            Back to shop
          </Link>
        </div>
      </div>
  ...
  return (
    ...
    <div className="relative">
      ...
      <main className="pt-24 pb-0">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
              ...
              <div className="flex items-center gap-0 border border-foreground/20 rounded-full overflow-hidden">
                ...
                <span className="w-10 text-center text-[12px] font-bold text-foreground">{quantity}</span>
                <button
        ...
        <div
          ref={ingredientsRef}
          className="mt-20 md:mt-32 bg-accent rounded-t-6xl pt-20 md:pt-28 pb-20 px-6 md:px-10"
        >
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16">
            <div className="scroll-reveal">
              ...
              <p className="font-body text-sm text-foreground/70 leading-relaxed max-w-md">
                Every ingredient is ethically sourced, sustainably harvested, and free from synthetic additives. 
                We believe in radical transparency — here's exactly what goes into this product.
              </p>
            </div>
            <div className="scroll-reveal">
              <ul className="space-y-4">
                {product.ingredients.map((ingredient, i) => (
                  ...
                  >
                    <span className="text-[10px] font-bold text-muted-foreground w-6">{String(i + 1).padStart(2, "0")}</span>
